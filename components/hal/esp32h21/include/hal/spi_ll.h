 ...
 *
 * On ESP32H21, this function is not separated
 *
 * @param hw Beginning address of the peripheral registers.
 */
 ...
 *
 * Note ESP32H21 doesn't support to use this feature when command/address phases
